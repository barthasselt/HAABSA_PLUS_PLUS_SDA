...
model_path = './models/fine_tuned_BART_2016_model'
tokenizer_path = './models/fine_tuned_BART_2016_tokenizer'
...
# Function to fill masked words, ensuring entire words are masked
...
def prepare_and_save_augmented_data(augmentation_method, postag=None):
    ...
    if augmentation_method == 'POS':
        augmented_txt_path = os.path.join(augmented_data_path, f'BART2016augmented_data_{augmentation_method}_{postag}.txt')
    else:
        augmented_txt_path = os.path.join(augmented_data_path, f'BART2016augmented_data_{augmentation_method}.txt')

...
# Add new words to the tokenizer's vocabulary
new_words = ["positive", "neutral", "negative"]
...
model.save_pretrained('./models/fine_tuned_EXPANDBERT_2016_model')
tokenizer.save_pretrained('./models/fine_tuned_EXPANDBERT_2016_tokenizer')
